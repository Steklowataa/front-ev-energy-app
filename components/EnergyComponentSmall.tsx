...
import { Props } from "../types/intensity"


export default function EnergyComponentSmall({ days , intensity , selectDay, nextDays }: Props) {
    ...
    return (
        ...
        <div className="animate-fadeIn w-[280px] h-[340px] rounded-[20px] bg-[#D9D9D9]/10 backdrop-blur-sm border-2 border-[#FF9237] shadow-[0_0_30px_rgba(77,84,100,1)] flex flex-col items-center justify-center">
            {/* <div className="flex flex-col justify-center items-center"> */}
                <p className="font-sans text-[#D9D9D9] text-bold text-[18px]">Energia {new Date(nextDays?.date).toLocaleDateString('pl-PL', { day: 'numeric', month: 'short' })}</p>
